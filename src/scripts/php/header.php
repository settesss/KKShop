            ...
            <nav class="header__nav">
                <ul class="header__list">
                    ...
                    <?php if (isset($_SESSION['user'])) : ?>
                        <li class="header__list-item">
                            <a class="header__link" href="profile.php#orders-block">История заказов</a>
                        </li>
                        <?php if ($_SESSION['user']['userType'] === 'seller') : ?>
                            <li class="header__list-item">
                                <a class="header__link" href="defaultProduct.php">Добавить товар</a>
                            </li>
                        <?php endif; ?>
                    <?php endif; ?>
                </ul>
                ...
                <ul class="header__menu-list">
                    <?php if (isset($_SESSION['user'])) : ?>
                        <li class="header__menu-item">
                            <a class="header__menu-link" href="profile.php#orders-block">
